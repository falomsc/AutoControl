...
def get_verify_tx_config(path: str) -> List[List[List[Dict[str, str]]]]:
    """
    ...
    tx_branch_list: [tx_branch1, tx_branch2, ...]
                    branch1         branch2
    tx_branch: {"pipe":str, "freq":str, "power":str, "branch":str}
    """
    ...
    for px in px_list:
        ...
        for fx in fx_list:
            ...
            for bx in bx_list:
                ...
                power = str(bx.xpath("./@power")[0])
                tx_branch = dict(pipe=pipe, freq=freq, power=power, branch=branch)
...
if __name__ == '__main__':
    for i in get_verify_tx_config("./tx_verify_all.xml"):
        print(i)
