        ...
        for tx_branch_list in tx_pipe_list:
            for tx_freq_list in tx_branch_list:
                for tx_freq in tx_freq_list:
                    ...
                    ############## notion ##############
                    input("\nPress Enter to conform the information: branch: {branch}, freq: {freq}, mode: {mode}, bandwidth: {bandwidth}!\n".format(**rf_params))
                    ...
                    if bandwidth.find('+') > -1:
                        ...
                        if pipe == "0":
                            if mode not in ("TM_2_1", "TM2_1A"):
                                ...
                                res_obw = multi_obw(v, rf_params, current1="OBW1", current2="OBW2", exs=True, delay=18,
                    ...
                    ############## 1 Carrier ##############
                        ...
                        if pipe == "0":
                            if mode not in ("TM_2_1", "TM2_1A"):
                                ...
                                res_obw = obw(v, rf_params, current="OBW", exs=True, delay=18,
